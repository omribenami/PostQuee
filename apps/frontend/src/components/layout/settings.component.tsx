    ...
    <>
      <div className="bg-newBgColorInner p-[20px] flex flex-col transition-all w-[260px]">
        ...
        <div>
          ...
          <div className="mt-4 pt-4 border-t border-customColor6">
            <a
              href="https://github.com/omribenami/PostQuee"
              target="_blank"
              rel="noopener noreferrer"
              className="text-xs text-textColor/60 hover:text-textColor transition-colors flex items-center gap-2"
            >
              <svg
                width="16"
                height="16"
              ...
              <span>{t('source_code', 'Source Code')}</span>
            </a>
          </div>
        </div>
      </div>
